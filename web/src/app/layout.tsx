...
export const metadata: Metadata = {
  ...
  description: "Companyi is a modern enterprise management platform that helps you organize companies, manage employees, structure departments, and track projects in one place.",
};
